...
ThemeData lightTheme(BuildContext context) {
  return FlexThemeData.light(
    ...
    chipTheme: ChipThemeData(
      backgroundColor:
          Color(0xff428AFF).withValues(alpha: 0.5), // Background color
      deleteIconColor: Colors.grey, // Delete icon color
      labelStyle: TextStyle(color: Color(0xff428AFF)), // Label text color
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(20),
...
ThemeData darkTheme(BuildContext context) {
  return FlexThemeData.dark(
    ...
    bottomSheetTheme: BottomSheetThemeData(
      backgroundColor: Colors.grey[900], // Darker color for dark theme
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(10),
      ),
    ),
    ...
    chipTheme: ChipThemeData(
      backgroundColor:
          Color(0xffFF5D21).withValues(alpha: 0.5), // Background color
      deleteIconColor: Color(0xffFF5D21), // Delete icon color
      labelStyle: TextStyle(color: Color(0xffFF5D21)), // Label text color
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(20),
    ...
    iconTheme: IconThemeData(color: Color(0xffFF5D21)),
  );
}
